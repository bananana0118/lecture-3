...
import main1_jpg from "../assets/_main1.jpg";
import main2_jpg from "../assets/_main2.jpg";
import main3_jpg from "../assets/_main3.jpg";
        ...
        const callback = (entries, observer) => {
            entries.forEach((entry) => {
                if (entry.isIntersecting) {
                    console.log("isIntersecting", entry.target.dataset.src);
    ...
    return (
        <div className="MainPage -mt-16">
            ...
            <div className="mx-auto">
                <ThreeColumns
                    columns={[
                        <Card webp={main1_webp} image={main1_jpg}>
                            롱보드는 아주 재밌습니다.
                        </Card>,
                        <Card webp={main2_webp} image={main2_jpg}>
                            롱보드를 타면 아주 신납니다.
                        </Card>,
                        <Card webp={main3_webp} image={main3_jpg}>
                            롱보드는 굉장히 재밌습니다.
                        </Card>,
                    ]}
                />
                ...
                <TwoColumns
                    ...
                    columns={[
                        ...
                        />,
                        <picture>
                            <source data-srcset={main_parts_webp} type="image/wepp" />
